...
import { errorConverter, errorHandler, exceptionFilter } from "./middlewares/error";
import ApiError from "./utils/ApiError";
import dotenv from "dotenv";
import bodyParser from "body-parser";
import checkAPI from "./middlewares/checkAPI";
import { setApp } from "./utils/helper";
import { wrapRoutes } from "./utils/catchAsync";
...
// wrapping all routes with catch async handler
wrapRoutes(routes);
