...
class AdminSettingTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        AdminSetting::firstOrCreate(['slug' => 'launchpad_first_title'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_first_description'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_second_title'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_second_description'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_apply_to_status'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_cover_image'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_main_image'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_apply_to_button_text'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'launchpad_why_choose_us_text'], ['value' => '']);
        AdminSetting::firstOrCreate(['slug' => 'icoTokenBuy_admin_approved'], ['value' => STATUS_ACTIVE]);
