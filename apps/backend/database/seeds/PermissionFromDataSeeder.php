...
class PermissionFromDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            //ICO
            ['group' => 'dynamic_form_settings','action' => 'ALL','for' => 'ICO Feature Permission','route' => $this->filtertext('dynamicFormCreateICO')],

            //knowledgebase
            ['group' => 'knowledgebase_dashboard','action' => 'ALL','for' => 'Knowledge Base Feature Permission','route' => $this->filtertext('knowledgebase_dashboard')],
            
            //staking
            ['group' => 'staking','action' => 'View','for' => 'Staking Dashboard','route' => $this->filtertext('stakingDashboard')],
