...
class BotOrderRemoveCommand extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            app('spot_orderbook_cache')->removeOrderBookByIds($buyIds, 'buy');
            ...
            app('spot_orderbook_cache')->removeOrderBookByIds($sellIds, 'sell');
            ...
            app('spot_orderbook_cache')->removeOrderBookByIds($buyIdsActive, 'buy');
            ...
            app('spot_orderbook_cache')->removeOrderBookByIds($sellIdsActive, 'sell');
