    ...
    public function storeERCorBEPCoinsettings($data)
    {
        CoinSetting::updateOrCreate(
            [
                ...
                'contract_coin_name' => $data['contract_coin_name'],
                'chain_link' => $data['chain_link'],
                'chain_id' => $data['chain_id'],
                'contract_address' => $data['contract_address'],
                'wallet_address' => $data['wallet_address'],
                'wallet_key' => $data['wallet_key'],
                'contract_decimal' => $data['contract_decimal'],
                'gas_limit' => $data['gas_limit'],
                'check_encrypt' => $data['check_encrypt'] 
            ]
        );

        $response = ['success'=>true, 'message'=>__('Coin settings store successfully')];
        return $response;
    }
