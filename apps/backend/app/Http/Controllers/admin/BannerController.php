    ...
    public function adminBannerSave(Request $request)
    {
        try {
            ...
            if ($response['success'] == true) {
                return redirect()->route('adminLandingSetting',['tab' => 'banner'])->with(['success'=> $response['message']]);
            } else {
                return redirect()->route('adminLandingSetting',['tab' => 'banner'])->with(['dismiss'=> $response['message']]);
            }
        } catch (\Exception $e) {
            return redirect()->route('adminLandingSetting',['tab' => 'banner'])->with('dismiss', __('Something went wrong'));
        }
    }
