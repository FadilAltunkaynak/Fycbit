...
class AddonsController extends Controller
{
    ...
    public function addonsSettings()
    {
        try {
            ...
            if(!empty($module)){
                ...
                if(isset($module['FutureTrade']))
                $data['FutureTrade'] = true;
    ...
    public function addonsLists()
    {
        ...
        try {
            ...
            'knowledgebase_support_module','page_builder_module','p2p_module','demo_trade_module', 'future_trade_module']);
            $data['list'] = [];
            ...
            if(!empty($module)){
                ...
                if(isset($module['FutureTrade']) && $setting['future_trade_module'] ?? false)
                {

                    $data['list'][] = [
                        'title' => 'Future Trade',
                        'url' => 'future.dashboard',
                    ];
                }
