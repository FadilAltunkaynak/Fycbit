...
Route::group(['group' => 'coin_pair'], function () {
    ...
    Route::get('trade/future-coin-pair-setting-{id}', 'TradeSettingController@coinPairSetting')->name('coinPairSetting');
});
...
Route::group(['middleware' => 'check_demo','group' => 'coin_pair'], function () {
    ...
    Route::post('trade/coin-pair-setting-update', 'TradeSettingController@coinPairSettingUpdate')->name('coinPairSettingUpdate');
});
