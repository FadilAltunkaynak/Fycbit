...
Route::group(['group' => 'check_deposit'], function () {
    Route::get('wallet-networks/{coinType}', 'DepositController@adminWalletNetworks')->name('adminWalletNetworks');
    ...
    Route::get('get-currency-{network_id?}', 'DepositController@getCurrencyByNetworkID')->name('getCurrencyByNetworkID');
});
