...
use Modules\FutureTrade\Services\CoinPairService\Traits\CacheAble;
...
Route::get('laravel-websockets/subscribes', function () {
    return view('admin.websockets.test');
...
//     $search = new CacheAble();
    
//     // 1) Create index
//     // dd($search->createIndex('test',[
//     //     'name' => 'TEXT',
//     //     'email' => 'TEXT',
//     //     'age' => 'NUMERIC'
//     // ]));
...
//     // 2) Add document
//     // dd($search->upsert('test', '1', [
//     //     'name' => 'A',
//     //     'email' => 'a@a.com',
//     //     'age' => '10'
//     // ]));

//     dd($search->search('test', '@email:a.com'));
// });
