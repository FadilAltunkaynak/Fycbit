...
<div>
    ...
    <div class="card text-light">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-12">
                    <strong>Network Base Type:</strong> {{ CoinProvider::tryFrom($transaction?->coin?->active_provider)?->getText() ?? __("Not Found") }}
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <strong>Status:</strong> {!! WithdrawStatus::tryFrom($transaction->status)->statusHtml() !!}
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
