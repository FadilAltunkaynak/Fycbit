        ...
        <div class="row no-gutters">
            <div class="col-12">
                ...
                <div class="tab-content" id="inlineTabContent">
                    ...
                    <!-- Withdraw Tab -->
                    <div class="tab-pane fade {{ @$tab == 'withdraw' ? 'show active' : '' }}" id="withdraw" role="tabpanel"
...
@section('script')
    <script>
                        ...
                        return `<div class="activity-icon">
                                            <ul style="gap: 10px">
                                                <li class="deleteuser m-0">
                                                    <a title="{{ __('View') }}" href="#" onclick="viewWithdrawalDetails('deposit', '${data.id}')" class="text-info" style="font-size: 20px">
        ...
        function viewWithdrawalDetails(type, item) {
            let url = '';
            if (type == 'deposit') {
