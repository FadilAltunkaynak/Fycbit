<ul class="d-flex activity-menu">
    ...
    <li class="viewuser">
        <a href="#delete1WV4d6uF6Ytu18v1Pl_{{ $item->id }}" data-toggle="modal" title="{{ __('Delete') }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer"><button type="button" class="btn btn-default"
                        ...
                        <a class="btn btn-danger"
                            href="{{ route('coinPairsDelete', encrypt($item->id)) }}">{{ __('Confirm') }}
                        </a>
                    </div>
                </div>
            </div>
    ...
    @if ($item->is_chart_updated == STATUS_PENDING)
        <li class="viewuser">
            <a href="#chart1WV4d6uF6Ytu18v1Pl_{{ $item->id }}" data-toggle="modal"
                title="{{ __('Update Chart Data') }}" class="btn btn-success btn-sm">
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer"><button type="button" class="btn btn-default"
                                data-dismiss="modal">{{ __('Close') }}</button>
                            <a class="btn btn-danger"
                                href="{{ route('coinPairsChartUpdate', encrypt($item->id)) }}">{{ __('Confirm') }}
                            </a>
                        </div>
                    </div>
                </div>
    ...
    @endif
    <li class="viewuser">
        <a href="{{ route('coinPairSetting', encrypt($item->id)) }}"
