                ...
                <div class="profile-info-form">
                    <div>
                        ...
                        @if($item->network == BITCOIN_API)
                            @include('admin.coin_management.crypto_currency.include.bitcoin')
                        @elseif($item->network == BITGO_API)
                            @include('admin.coin_management.crypto_currency.include.bitgo')
                        @else
                            @include('admin.coin_management.crypto_currency.include.erc20')
                        @endif
                        <div class="row">
                            <div class="col-md-2">
                        ...
                        @if($item->network == BITGO_API)
                            ...
                            @include('admin.coin_management.crypto_currency.include.webhook')
                            <div class="row">
                                <div class="col-md-2">
                                    @if(isset($item))<input type="hidden" name="coin_id" value="{{encrypt($item->coin_id)}}">  @endif
