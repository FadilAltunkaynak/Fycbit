...
{!! subMenuRenderer(__('Coin Management'),$menu ?? '', 'coin_namagement','coin.svg',[
    ['route' => 'supportedNetworkList', 'title' => __('Supported Network'),'tab' => $sub_menu ?? '', 'tab_compare' => 'supported_network', 'route_param' => NULL ],
    ['route' => 'getNetworkList', 'title' => __('Networks'),'tab' => $sub_menu ?? '', 'tab_compare' => 'network', 'route_param' => NULL ],
    ['route' => 'adminCoinList', 'title' => __('Crypto Currency'),'tab' => $sub_menu ?? '', 'tab_compare' => 'crypto_currency', 'route_param' => NULL ],
    ['route' => 'getCoinNetworkList', 'title' => __('Coin Network'),'tab' => $sub_menu ?? '', 'tab_compare' => 'coin_network', 'route_param' => NULL ],
...
{!! mainMenuRenderer('getSystemWalletList',__('System Wallet'),$menu ?? '','system_wallet','staking.svg') !!}
...
{!! subMenuRenderer(__('Landing Settings'),$menu ?? '', 'landing_setting','landing-settings.svg',[
    ...
    ['route' => 'adminFooterColumnHeader', 'title' => __('Footer Column Headers'),'tab' => $sub_menu ?? '', 'tab_compare' => 'footer_column_header', 'route_param' => NULL ],
