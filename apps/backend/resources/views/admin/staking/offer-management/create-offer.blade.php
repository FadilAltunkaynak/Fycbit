                            ...
                            <div class="row">
                                <div class="col-md-6 mt-20">
                                    <div class="form-group">
                                        ...
                                        <div class="cp-select-area customSelect ">
                                            <select name="coin_type" class="selectpicker" title="{{ __('Select Coin') }}"
                                                data-live-search="true" data-width="100%" data-style="btn-info"
                                                data-actions-box="true" data-selected-text-format="count > 4">
                                                @if (isset($coin_list))
                                ...
                                <div class="col-md-6 mt-20">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="period" class="form-control"
                                            placeholder="{{ __('Enter period in days') }}" value="{{ old('period') }}">
                                ...
                                <div class="col-md-6 mt-20">
                                    <div class="form-group">
                                        ...
                                        <div class="cp-select-area customSelect ">
                                            <select name="terms_type" class="selectpicker" title="{{ __('Select Coin') }}"
                                                data-live-search="true" data-width="100%" data-style="btn-info"
                                                data-actions-box="true" data-selected-text-format="count > 4">
                                ...
                                <div class="col-md-6 mt-20">
                                    <div class="form-group">
                                        <label>{{ __('User Registration Before') }} ({{ __('Days') }})
                                            ({{ __('Optional') }})</label>
                                ...
                                <div class="col-md-6 mt-20">
                                    <div class="form-group">
                                        <label>{{ __('User Minimum Holding Amount') }} ({{ __('Days') }})
                                            ({{ __('Optional') }})</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cp-select-area customSelect ">
                                            <select name="status" class="selectpicker"
                                                title="{{ __('Select Status') }}" data-live-search="true"
                                                data-width="100%" data-style="btn-info" data-actions-box="true"
                                                data-selected-text-format="count > 4">
                                                <option value="{{ STATUS_INACTIVE }}"
