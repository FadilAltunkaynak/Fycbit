@extends('admin.master',['menu'=>'setting', 'sub_menu'=>'launchapad_settings'])
        ...
        <div class="row">
            <div class="col-12">
                <div class="profile-info-form">
                    <div class="card-body">
                        <form action="{{route('launchpadSettingsUpdate')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="row">
                                                ...
                                                <div class="form-group buy_coin_address_input ">
                                                    <div id="file-upload" class="section-p">
                                                        <input type="file" name="image" value=""
                                                            ...
                                                            @if(isset($launchpad_cover_image) && (!empty($launchpad_cover_image)))  data-default-file="{{asset(path_image().$launchpad_cover_image)}}" @endif />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
