        ...
        <div class="row no-gutters">
            <div class="col-12 col-lg-3 col-xl-2">
                <ul class="nav user-management-nav mb-3" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="@if(isset($tab) && $tab=='module_setting') active @endif nav-link " id="pills-email-tab"
                           data-toggle="pill" data-controls="module_setting" href="#module_setting" role="tab"
                           aria-controls="pills-email" aria-selected="true">
                            <span>{{__('Module Settings')}}</span>
                        </a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-12 col-lg-9 col-xl-10">
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane @if(isset($tab) && $tab=='module_setting') show active @endif" id="module_setting"
                         role="tabpanel" aria-labelledby="pills-email-tab">
                        @include('admin.settings.feature.module_setting')
                    </div>
