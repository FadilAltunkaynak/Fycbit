                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="display_link">
                            ...
                            <div class="form-group">
                                <label for="landing_fourth_section_status">{{__('Section Status')}}</label>
                                <select id="landing_fourth_section_status" name="landing_fourth_section_status" class="form-control">
