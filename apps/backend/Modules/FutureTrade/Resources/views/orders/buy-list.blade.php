...
@section('sidebar')
@include('futureTrade::layouts.sidebar',['menu'=>'buy_orders'])
@endsection
@section('content')
    ...
    <div class="custom-breadcrumb">
        <div class="row">
            <div class="col-12">
                <ul>
                    <li class="active-item">{{__('Future Buy Orders')}}</li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header border-0 pb-0">
                    <h5 class="modal-title font-weight-bold">{{__('Buy Order Details')}}</h5>
