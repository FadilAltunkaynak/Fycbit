...
@section('sidebar')
@include('futureTrade::layouts.sidebar',['menu'=>'position_history_list'])
@endsection
@section('content')
    ...
    <div class="custom-breadcrumb">
        <div class="row">
            <div class="col-12">
                <ul>
                    <li class="active-item">{{__('Futures position Histories')}}</li>
                </ul>
            </div>
        </div>
    </div>
...
<script>
    ...
    function getPositionDetails(uid){
        let url = '{{ route("future.position.get-modal-position-history") }}';
