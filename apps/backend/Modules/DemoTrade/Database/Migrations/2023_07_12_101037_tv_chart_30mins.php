...
class TvChart30mins extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('DemoTradeMysql')->create('tv_chart_30mins', function (Blueprint $table) {
    ...
    {
        Schema::connection('DemoTradeMysql')->dropIfExists('tv_chart_30mins');
    }
}
