...
class TvChart1days extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('DemoTradeMysql')->create('tv_chart_1days', function (Blueprint $table) {
    ...
    {
        Schema::connection('DemoTradeMysql')->dropIfExists('tv_chart_1days');
    }
}
