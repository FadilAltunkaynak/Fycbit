...
class TvChart15mins extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('DemoTradeMysql')->create('tv_chart_15mins', function (Blueprint $table) {
    ...
    {
        Schema::connection('DemoTradeMysql')->dropIfExists('tv_chart_15mins');
    }
}
