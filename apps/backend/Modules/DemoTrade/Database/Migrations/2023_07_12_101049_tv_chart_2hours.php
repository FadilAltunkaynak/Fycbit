...
class TvChart2hours extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('DemoTradeMysql')->create('tv_chart_2hours', function (Blueprint $table) {
    ...
    {
        Schema::connection('DemoTradeMysql')->dropIfExists('tv_chart_2hours');
    }
}
