...
use Modules\DemoTrade\Http\Services\TransService;
use Modules\DemoTrade\Http\Services\WalletService;
...
class WalletController extends Controller
{
    ...
    {
        try {
            $response = $this->service->userWalletList(getUserId(),$request);
        } catch (\Exception $e) {
