...
@section('content')
    ...
    <div class="custom-breadcrumb">
        <div class="row">
            ...
            <div class="col-3">
                <a class="btn theme-btn float-right" href="{{route('support_category_add')}}">{{__('Add New')}}</a>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="d-flex activity-menu">
                                            <li class="viewuser">
                                                <a href="{{route('support_category_edit', $category->unique_code)}}" title="{{__("Update")}}" class="btn btn-primary btn-sm">
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">{{__("Close")}}</button>
                                                                <a class="btn btn-danger"href="{{route('support_category_delete', $category->unique_code)}}">{{__('Confirm')}} </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
