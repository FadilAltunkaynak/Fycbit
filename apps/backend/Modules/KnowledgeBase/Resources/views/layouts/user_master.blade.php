...
<head>
    ...
    <title>{{__('Knowledgebase index')}}</title>
    ...
    <!-- slide  -->
    <link rel="stylesheet" href="{{ asset('assets/modules/knowledgebase/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/modules/knowledgebase/css/owl.theme.default.min.css') }}">
...
<section class="bg_image py-5" style="@if(Request::route()->getName() != "articleDetails") background-image:url({{$cover_image}}) @endif">
    @include('knowledgebase::layouts.user_header')
    @if(Request::route()->getName() != "articleDetails")
        @include('knowledgebase::layouts.support_search')
    @endif
</section>
@yield('content')
</div>
...
<script src="{{ asset('assets/modules/knowledgebase/js/owl.carousel.min.js')}}"></script>
<script src="{{ asset('assets/modules/knowledgebase/js/jquery.min.js')}}"></script>
